...
int LIDARLite::distance(bool biasCorrection, char lidarliteAddress)
{
  ...
  read_success = read(0x8f,2,distanceArray,true,lidarliteAddress);
...
/*------------------------------------------------------------------------------
  ...
  8/8/26 Mod: Adding in function return value to communciate errors for FDIR. Lorenzo P
